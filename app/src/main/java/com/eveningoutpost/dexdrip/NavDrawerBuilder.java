...
import com.eveningoutpost.dexdrip.NavigationDrawerFragment.NavDrawerItem;
...
public class NavDrawerBuilder {
    ...
    public final List<String> nav_drawer_names = getAllStrings();
    public final List<Intent> nav_drawer_intents = getAllIntents();

    public List<NavDrawerItem> nav_drawer_options = new ArrayList<NavDrawerItem>();
...
//            this.nav_drawer_intents.add(new Intent(context, Preferences.class));
            ...
            nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.settings),
                    new Intent(context, Preferences.class),
...
//        this.nav_drawer_intents.add(new Intent(context, Home.class));
        ...
        nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.home_screen),
                new Intent(context, Home.class),
                R.drawable.jamorham_parakeet_marker));
...
//            this.nav_drawer_intents.add(new Intent(context, CalibrationGraph.class));
            ...
            nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.calibration_graph),
                    new Intent(context, CalibrationGraph.class),
...
//            this.nav_drawer_intents.add(new Intent(context, BgReadingTable.class));
            ...
            nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.bg_data_table),
                    new Intent(context, BgReadingTable.class)));
...
//            this.nav_drawer_intents.add(new Intent(context, CalibrationDataTable.class));
            ...
            nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.calibration_data_table),
                    new Intent(context, CalibrationDataTable.class)));
        }
...
//            this.nav_drawer_intents.add(new Intent(context, AddCalibration.class));
            ...
            nav_drawer_options.add(new NavDrawerItem(context.getString(R.string.add_calibration),
                    new Intent(context, AddCalibration.class)));
...
//                                    this.nav_drawer_intents.add(new Intent(context, CalibrationOverride.class));
                                    ...
                                    nav_drawer_options.add(new NavDrawerItem(
                                            context.getString(R.string.override_calibration),
                                            new Intent(context, CalibrationOverride.class)));
...
//                                    this.nav_drawer_intents.add(new Intent(context, AddCalibration.class));
                                    ...
                                    nav_drawer_options.add(new NavDrawerItem(
                                            context.getString(R.string.add_calibration),
                                            new Intent(context, AddCalibration.class)));
                                }
                            } else {
...
//                                this.nav_drawer_intents.add(new Intent(context, Home.class));
                                ...
                                nav_drawer_options.add(new NavDrawerItem(
                                        context.getString(R.string.cannot_calibrate_right_now),
                                        new Intent(context, Home.class)));
                            }
                        } else {
...
//                                this.nav_drawer_intents.add(new Intent(context, DoubleCalibrationActivity.class));
                                ...
                                nav_drawer_options.add(new NavDrawerItem(
                                        context.getString(R.string.initial_calibration),
                                        new Intent(context, DoubleCalibrationActivity.class)));
                            }
                        }
                    }
                }
...
//        this.nav_drawer_intents.add(new Intent(context, Preferences.class));
    ...
    public List<String> getAllStrings(){
        ...
        for(NavDrawerItem item : nav_drawer_options){
